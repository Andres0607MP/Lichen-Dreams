...
class ApiService {
  ...
  Future<void> deleteAdminSpecies(int id) async {
    ...
    if (response.statusCode != 204 && response.statusCode != 200) {
      throw ApiException(
        _parseResponseMessage(
          response,
          'Error ${response.statusCode} al eliminar especie',
        ),
      );
    }
  }
  ...
  Future<List<dynamic>> getCatalogZones() async {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(response, 'Error ${response.statusCode} al obtener zonas del catÃ¡logo'),
      );
    }
    return jsonDecode(response.body) as List<dynamic>;
    });
  ...
  Future<void> changePassword({
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(response, 'Error ${response.statusCode} al cambiar contraseÃ±a'),
      );
    }
  }
  ...
  Future<List<dynamic>> getMyAnalyses() async {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(response, 'Error ${response.statusCode} al obtener anÃ¡lisis'),
      );
    }
    final decoded = jsonDecode(response.body);
    if (decoded is List) {
  ...
  Future<Map<String, dynamic>> updateAnalysisVisibility(int analysisId, String visibility) async {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(
          response,
          'Error ${response.statusCode} al actualizar visibilidad',
        ),
      );
    }
    return jsonDecode(response.body) as Map<String, dynamic>;
  ...
  Future<List<dynamic>> getSessions() async {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(
          response,
          'Error ${response.statusCode} al obtener sesiones',
        ),
      );
    }
    final decoded = jsonDecode(response.body);
  ...
  Future<void> revokeSession(int sessionId) async {
    ...
    if (response.statusCode != 204) {
      throw ApiException(
        _parseResponseMessage(
          response,
          'Error ${response.statusCode} al revocar sesiÃ³n',
        ),
      );
    }
  }
  ...
  Future<Map<String, dynamic>> forgotPassword(String email) async {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(
          response,
          'Error ${response.statusCode} al solicitar recuperaciÃ³n',
        ),
      );
    }
    return jsonDecode(response.body) as Map<String, dynamic>;
  ...
  /// Restablecer contraseÃ±a con cÃ³digo de recuperaciÃ³n
  Future<Map<String, dynamic>> resetPassword(String token, String newPassword) async {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(
          response,
          'Error ${response.statusCode} al restablecer contraseÃ±a',
        ),
      );
    }
    return jsonDecode(response.body) as Map<String, dynamic>;
  ...
  /// Recuperar contraseÃ±a usando el cÃ³digo de recuperaciÃ³n de un solo uso
  ...
  /// Generar un nuevo cÃ³digo de recuperaciÃ³n para el usuario autenticado
  Future<Map<String, dynamic>> regenerateRecoveryCode() async {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(
          response,
          'Error ${response.statusCode} al generar el cÃ³digo de recuperaciÃ³n',
        ),
      );
    }
    return jsonDecode(response.body) as Map<String, dynamic>;
  ...
  /// Verificar correo electrÃ³nico con cÃ³digo de verificaciÃ³n
  ...
  Future<Map<String, dynamic>> resendVerification(String email) async {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw ApiException(
        _parseResponseMessage(
          response,
          'Error ${response.statusCode} al reenviar cÃ³digo',
        ),
      );
    }
    return jsonDecode(response.body) as Map<String, dynamic>;
